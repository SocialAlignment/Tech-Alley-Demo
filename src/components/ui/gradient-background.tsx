...
export const GradientBackground = () => (
    <>
        ...
        <svg width="100%" height="100%" viewBox="0 0 800 600" fill="none" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid slice" className="absolute top-0 left-0 w-full h-full pointer-events-none">
            <defs>
                <linearGradient id="rev_grad1" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style={{ stopColor: 'var(--color-primary, #3b82f6)', stopOpacity: 0.8 }} /><stop offset="100%" style={{ stopColor: 'var(--color-chart-3, #a855f7)', stopOpacity: 0.6 }} /></linearGradient>
                <linearGradient id="rev_grad2" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" style={{ stopColor: 'var(--color-chart-4, #ec4899)', stopOpacity: 0.9 }} /><stop offset="50%" style={{ stopColor: 'var(--color-secondary, #64748b)', stopOpacity: 0.7 }} /><stop offset="100%" style={{ stopColor: 'var(--color-chart-1, #e11d48)', stopOpacity: 0.6 }} /></linearGradient>
                <radialGradient id="rev_grad3" cx="50%" cy="50%" r="50%"><stop offset="0%" style={{ stopColor: 'var(--color-destructive, #ef4444)', stopOpacity: 0.8 }} /><stop offset="100%" style={{ stopColor: 'var(--color-chart-5, #eab308)', stopOpacity: 0.4 }} /></radialGradient>
            ...
            <g style={{ animation: 'float2 25s ease-in-out infinite' }}>
                ...
                <ellipse cx="50" cy="150" rx="180" ry="120" fill="var(--color-accent, #22c55e)" filter="url(#rev_blur2)" opacity="0.8" />
            </g>
        </svg>
    </>
);
