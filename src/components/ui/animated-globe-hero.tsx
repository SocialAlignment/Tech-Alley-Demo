...
export const AnimatedGlobeHero = ({
    ...
    return (
        <section
            className={cn(
                "relative w-full min-h-[50vh] flex flex-col items-center justify-center text-center overflow-hidden bg-transparent p-4 md:p-8",
                className
            )}
        >
            <div className="z-10 flex flex-col items-center space-y-6 md:space-y-8 max-w-4xl mx-auto">
                {/* Optional Badge */}
                {badgeText && (
                    <div className="inline-flex items-center rounded-lg bg-muted px-3 py-1 text-sm font-medium text-muted-foreground border border-white/10">
                        {badgeText}
                    </div>
                )}
            ...
            <div className="absolute -bottom-[25%] md:-bottom-[40%] lg:-bottom-[50%] -z-0 w-full max-w-screen-lg opacity-40 dark:opacity-30 pointer-events-none">
                <img
                    src={globeSrc}
