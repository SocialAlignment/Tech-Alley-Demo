...
**Brand Name:** Tech Alley Henderson
...
If you need to place logos or understand the relationship between Tech Alley, Social Alignment, and Dead Sprint Radio, read:
👉 **[`resources/brand-assets.md`](resources/brand-assets.md)**
